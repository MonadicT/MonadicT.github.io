...
public class SoftReferenceTest {
    ...
    /* Cache with a bunch of SoftReference objects */
    static Map<String, SoftReference> cache
    ...
    /**
     * Populates cache with objects wrapped in SoftReference
     */
    static void populateCache() {
        for (int i = 0; i < cachedObjCnt; i++) {
            Object o = new byte[objSize];
            cache.put("Key" + i, new SoftReference(o));
